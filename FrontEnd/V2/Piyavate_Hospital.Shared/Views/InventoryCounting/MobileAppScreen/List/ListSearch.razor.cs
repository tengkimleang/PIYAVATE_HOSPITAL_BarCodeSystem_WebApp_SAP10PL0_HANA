...
namespace Piyavate_Hospital.Shared.Views.InventoryCounting.MobileAppScreen.List;
...
public partial class ListSearch
{
    ...
    {
        await ViewModel.IssueForProductionDeatialByDocNumCommand.ExecuteAsync(docEntry).ConfigureAwait(false);
        _isViewDetail=true;
    }
